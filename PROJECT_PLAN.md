...
| T-5.4 | Custom Citation Accuracy (LLM-as-judge, FinGuard G-Eval pattern) | T-5.3 | `WIP` (blocked on citation over-attachment bug fix, see below) |
