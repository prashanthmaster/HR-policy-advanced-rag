...
- No probe becomes a scored golden item while it carries `[VERIFY]`. Currently: P-01 (ceiling commencement), P-17 (DIFC divergence), and the UAE 1980→2021 transition case.
