# Germany — Statutory HR Law (Tier 1: real public statutory sources)

Primary source: Bürgerliches Gesetzbuch (BGB — German Civil Code), Section 622 (Kündigungsfristen bei Arbeitsverhältnissen / Notice periods for termination of employment relationships).

---
clause_id: DE-BGB622-P1-BASE
country: Germany
doc_type: law
source_act: Bürgerliches Gesetzbuch (BGB)
section: § 622 Abs. 1
...
---
clause_id: DE-BGB622-P2-GRADUATED
country: Germany
doc_type: law
source_act: Bürgerliches Gesetzbuch (BGB)
section: § 622 Abs. 2
...
---
clause_id: DE-BGB622-P3-PROBATION
country: Germany
doc_type: law
source_act: Bürgerliches Gesetzbuch (BGB)
section: § 622 Abs. 3
...
---
clause_id: DE-BGB622-P6-SYMMETRY
country: Germany
doc_type: law
source_act: Bürgerliches Gesetzbuch (BGB)
section: § 622 Abs. 6
...
---
clause_id: DE-KSCHG-SCOPE
country: Germany
doc_type: law
source_act: Kündigungsschutzgesetz (KSchG — Dismissal Protection Act)
section: § 1, § 23 (scope)
...
---
NOTE: Germany has no statutory "gratuity" or lump-sum end-of-service payment equivalent to India's or the UAE's — severance (Abfindung) is not a general statutory entitlement on ordinary termination, but is typically negotiated, awarded via a Sozialplan (social plan) in larger layoffs, or ordered by a labour court under §§ 9-10 KSchG when a court dissolves an employment relationship. This is a genuine, defensible cross-country conflict for the RAG to navigate correctly: a query modeled on India/UAE ("what is the gratuity entitlement in Germany") does not have a matching statutory answer, and the system should say so rather than inventing a number or blending in an India/UAE figure.
